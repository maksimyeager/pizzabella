...
import { clearCart } from "../redux/cart/slice.ts";
...
const Cart: React.FC = () => {
    ...
    const totalCountProducts = products.reduce((sum: number, obj: any) => {
        ...
        <div className="container container--cart">
            <div className="cart">
                <div className="cart__top">
                    ...
                    <div className="cart__clear" onClick={handleCartClear}>
                        <svg
                            width="20"
                            height="20"
                            viewBox="0 0 20 20"
                ...
                <div className="cart__bottom">
                    <div className="cart__bottom-details">
                        <span>
                            {" "}
                            Всего пицц: <b>{totalCountProducts} шт.</b>{" "}
                        </span>
                        <span>
                            {" "}
